...
// voor de game loop moet er nog in komen dat elke loop in de while ook word gekeken of m_is_game_done true is. Als is geen zetten kunnen worden geplaatst dan is het sspel ook afgelopen.
